...
const styles = {
  note: {
    ...
    body: 'text-amber-800 [--tw-prose-background:var(--color-amber-50)] prose-a:text-amber-900 prose-code:text-amber-900 dark:text-zinc-300 dark:prose-code:text-zinc-300',
  },
  warning: {
    container:
      'bg-amber-50 dark:bg-zinc-800/60 dark:ring-1 dark:ring-zinc-300/10',
