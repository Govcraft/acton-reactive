  ...
  return (
    ...
    >
      <div
        id={`${id}-title`}
        aria-hidden="true"
        className="text-sm text-zinc-700 group-aria-selected:text-amber-600 dark:text-zinc-300 dark:group-aria-selected:text-amber-400"
      >
    ...
    <>
      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto px-4 py-4 sm:px-6 sm:py-20 md:py-32 lg:px-8 lg:py-[15vh]">
          <DialogPanel className="mx-auto transform-gpu overflow-hidden rounded-xl bg-white shadow-xl sm:max-w-xl dark:bg-zinc-800 dark:ring-1 dark:ring-zinc-700">
