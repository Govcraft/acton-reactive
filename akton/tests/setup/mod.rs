...
pub fn init_tracing() {
    INIT.call_once(|| {
        ...
        let filter = EnvFilter::new("")
            ...
            .add_directive("akton_core::common::broker=warn".parse().unwrap())
            .add_directive("akton_core::common::broker[broadcast]=trace".parse().unwrap())
            ...
            .add_directive("akton_core::actors::idle=off".parse().unwrap())
            .add_directive("akton_core::actors::idle[act_on_async]=off".parse().unwrap())
            .add_directive("akton_core::actors::idle[act_on]=off".parse().unwrap())
            .add_directive("akton_core::message::outbound_envelope=off".parse().unwrap())
            .add_directive("akton_core::message::broadcast_envelope=off".parse().unwrap())
            .add_directive("akton_core::traits::broker_context=trace".parse().unwrap())
