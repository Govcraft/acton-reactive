...
pub fn initialize_tracing() {
    INIT.call_once(|| {
        ...
        let filter = EnvFilter::new("")
            ...
            .add_directive("acton_core::actors::actor=error".parse().unwrap())
            ...
            .add_directive("acton_core::actors::managed_actor=info".parse().unwrap())
            .add_directive("acton_core::actors::actor[wake]=error".parse().unwrap())
            .add_directive("acton_core::actors::actor[terminate_actor]=off".parse().unwrap())
            .add_directive("acton_core::actors::actor[handle_message]=trace".parse().unwrap())
            .add_directive("acton_core::actors::actor[suspend_self]=off".parse().unwrap())
            .add_directive("acton_core::actors::actor[new]=error".parse().unwrap())
            .add_directive("acton_core::actors::actor[init]=error".parse().unwrap())
            .add_directive("acton_core::actors::actor[activate]=error".parse().unwrap())
            .add_directive("acton_core::actors::idle=off".parse().unwrap())
            .add_directive("acton_core::actors::idle[act_on_async]=off".parse().unwrap())
            .add_directive("acton_core::actors::idle[act_on]=off".parse().unwrap())
            ...
            .add_directive("acton::tests::setup::actors::pool_item=info".parse().unwrap())
